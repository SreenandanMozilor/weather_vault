...
from weather_app_python.db.utils import create_database, drop_database
from weather_app_python.services.redis.dependency import get_redis_pool
from weather_app_python.settings import settings
from weather_app_python.web.application import get_app
...
async def _engine(anyio_backend: Any) -> AsyncGenerator[AsyncEngine]:
    ...
    :yield: new engine.
    """
    from weather_app_python.db.meta import meta
    from weather_app_python.db.models import load_all_models
